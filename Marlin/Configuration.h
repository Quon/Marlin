...
#define STRING_CONFIG_H_AUTHOR "(TwoTrees, sappireTFT35)" // Who made the changes.
...
//@
#define CUSTOM_MACHINE_NAME "TwoTrees"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -44, -0.95 }
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   5 // Z Clearance for Deploy/Stow 探针使用时z轴抬起放下距离
...
// For M851 give a range for adjusting the Z probe offset Zoffset可调节范围
 ...
 * 探测过程中的附加选项
 */
//#define PROBING_HEATERS_OFF       // Turn heaters off when probing 探测是关闭加热
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_RETRACT_MULTIPLIER   8  // G26 Q (retraction) used by default between mesh test elements.
  #endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 2), (Y_MAX_POS - 10), 50 }
